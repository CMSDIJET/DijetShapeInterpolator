...
void create_Signal_shape_histos_slices(){
	...
	TFile *fout7 = new TFile ("inputs_slices/InputShapes_alpha0p25_2and4TeV_slice7_forAN.root","recreate");
	TFile *fout8 = new TFile ("inputs_slices/InputShapes_alpha0p25_2and4TeV_slice8_forAN.root","recreate");
	TFile *fout9 = new TFile ("inputs_slices/InputShapes_alpha0p25_2and4TeV_slice9_forAN.root","recreate");
	...
	for (int j1 = 0; j1 < 11; j1++)
	{
		...
		{ 
			...
			if( f1->IsOpen() && ( (j1==0 && j2==0) ||  (j1==2 && j2==2) ) )
			{
